...
const diagonal = (data, reverse = false) => {
    const diagonal = data.reduceRight((acc, curr, i) => {
        if (reverse) {
            curr = curr.reverse();
        }
